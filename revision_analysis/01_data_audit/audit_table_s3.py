...
def write_report(
    ...
    lines.extend([
        ...
        "six-hour rows using an arithmetic mean. Before submission, the caption and Methods must either "
        "describe this as mean six-hour urine output or the table must be regenerated from patient-day sums.",
        "",
        "## Files produced",
        "",
